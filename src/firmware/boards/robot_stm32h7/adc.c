...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = DRIBBLER_CSOUT_Pin|GPIO_PIN_1;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = ENCODER_FRONT_LEFT_SIN_Pin|ENCODER_FRONT_LEFT_COS_Pin|ENCODER_BACK_LEFT_COS_Pin|ENCODER_BACK_LEFT_SIN_Pin
                          |ENCODER_BACK_RIGHT_COS_Pin|ENCODER_BACK_RIGHT_SIN_Pin|HV_SENSE_PWR_BRD_Pin|GPIO_PIN_10;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, DRIBBLER_CSOUT_Pin|GPIO_PIN_1);
